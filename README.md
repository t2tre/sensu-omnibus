...
10. Unless you will be building a new Saved Image, select `a` from ``.
...
make depend
make
#make test # this fails right now
make install
cd ..
```
...
**NOTE: if `make` complains about `.va_copy` being an undefined symbol,
